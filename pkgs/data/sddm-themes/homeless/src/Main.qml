...
Rectangle {
    ...
    readonly property color textDim:    "#6D8E81"
    ...
    // Background
    Rectangle { anchors.fill: parent; color: "#051014" }
        ...
        Column {
            ...
            Item {
                ...
                Rectangle {
                    anchors.bottom: parent.bottom; anchors.left: parent.left; anchors.right: parent.right
                    height: 1 * s
                    color: Qt.rgba(0.45, 0.65, 0.40, 0.25)
                }
                // Focus track
                Rectangle {
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        color: submitMouse.containsMouse
                               ? Qt.rgba(0.45, 0.65, 0.40, 0.18)
                               : "transparent"
                        border.color: Qt.rgba(0.45, 0.65, 0.40, passwordField.text.length > 0 ? 0.55 : 0.20)
                        border.width: 1 * s
    ...
    Rectangle {
        ...
        height: 1 * s; color: Qt.rgba(0.45, 0.65, 0.40, 0.18); opacity: root.ui
    }
    Item {
        anchors.bottom: parent.bottom
        anchors.left: parent.left; anchors.right: parent.right
